...
//   };
//   return (
//     <div className="w-full flex items-center justify-between p-2 rounded-lg bg-white">
//       {/* Card one code */}
...
//           className="flex-1 min-w-[150px]  p-1 border-b-2 border-blue-500 focus:outline-none text-lg text-nowrap text-gray-800"
//           autoFocus
//         />
//       ) : (
//         <span
...
//   const handleEditSave = () => {
//     // Corrected condition: check if the new text is different from the original text
...
//   return (
//     // This is the single task card. The width should be full here
//     // as the two-column layout will be managed by the parent component.
//     <div className="flex items-center md:flex-row justify-between flex-wrap gap-2 p-4 bg-white border border-gray-200 rounded-lg shadow-sm">
//       {isEditing ? (
//         <input
//           type="text"
//           value={editText}
