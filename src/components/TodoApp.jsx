    ...
    return (
        <div className='min-h-screen p-8'>
            <div className='bg-white rounded-xl md:w-6/12 mx-auto py-6 shadow-2xl'>
                <h1 className='text-3xl font-bold text-center text-gray-800 mb-6'>To-Do <span className='text-gradient-to-r from-indigo-500 from-10% via-sky-500 via-30% to-emerald-500 to-90%'>List App</span></h1>
